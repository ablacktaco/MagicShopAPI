...
class MagicBookList {
    ...
    static let shared = MagicBookList()
    
    var bookLists: [MagicBook.Data]?
...
//    ]
    ...
    var level1: [MagicBook.Data] {
        return bookLists!.filter {($0.level == "one")}
    }
    
    var level2: [MagicBook.Data] {
        return bookLists!.filter {($0.level == "two")}
    }
    
    var level3: [MagicBook.Data] {
        return bookLists!.filter {($0.level == "three")}
    }
